# Most of the code here is from https://github.com/openai/baselines/blob/tf2/baselines/common/atari_wrappers.py
...
class ReplayMemory:
    ...
    def __init__(self, capacity, state_shape=(84, 84), history_len=4, batch_size=32, verbose=True):
    ...
    def push(self, state, action, reward, next_state, terminal):
        ...
        trsn = Experience(state, action, reward, next_state, terminal)
